...
while($student = mysqli_fetch_assoc($student_data)){  ?>
        <tr>
            ...
            <td class="noprint"><a href="student_view.php?id=<?php echo $student['id']; ?> & location=students.php " class="btn btn-primary">عرض</a>
                <a href="student_edit.php?id=<?php echo $student['id']; ?> " class="btn btn-secondary">تعديل</a>
                <a href="student_delete.php?id=<?php echo $student['id']; ?>& action=trash " class="btn btn-danger">طرد</a>
            </td>
        </tr>
