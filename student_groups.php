...
if(isset($_GET['group'])){
  ...
  if(isset($group_id_array)) {$last_id = $group_id_array['id'] ;}
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" id="add" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    ...
    <div class="modal-header">
      ...
      <div class="form-group col-lg-10 mt-4" >
                ...
                <input class="form-control mt-2" type="text" disabled placeholder="<?php echo ($last_group['id']+1) ?>">
              </div>
              ...
              <div class="form-group col-lg-10 mt-4" >
                ...
                <input class="form-control mt-2" id="description" name="description" type="text" required >
              </div>
              ...
              <div class="form-group col-lg-10 mt-4" >
                ...
                <input class="form-control mt-2" type="text" placeholder="<?php echo $teacher_full_name ;?>" disabled >
              </div>
      </div>
...
?>
        <div class='row'>
          <h5 class="font-weight-bold text-black mt-5 col-lg-3 col-sm-12 ">رقم المجموعه : <span class="text-primary"><?php echo $student_group_id  ; ?></span></h5>
          <h5 class="font-weight-bold text-black mt-5 col-lg-3 col-sm-12 ">اسم المجموعه : <span class="text-primary"><?php echo $student_group_name ; ?></span></h5>
          <h5 class="font-weight-bold text-black mt-5 col-lg-6 col-sm-12 ">وصف المجموعه : <span class="text-primary"><?php echo $student_group_description; ?></span></h5>
        </div>
        <div class='row'>
          <h5 class="font-weight-bold text-black col-lg-3 col-sm-12 ">مصروفات المجموعه: <span class="text-primary"><?php echo $student_group_price . " ج.م " ; ?></span></h5>
          <h5 class="font-weight-bold text-black col-lg-3 col-sm-12 "> ميعاد امتحان المجموعه : <span class="text-primary"><?php  ?></span></h5>
        </div>
<?php } ?>
...
while($student = mysqli_fetch_assoc($student_data)){  ?>
        <tr>
            ...
            <td><a href="student_view.php?id=<?php echo $student['id']; ?> & location=student_groups.php " class="btn btn-primary">عرض</a>
                <a href="student_delete.php?id=<?php echo $student['id']; ?>& action=remove_from_group " class="btn btn-danger">حذف من المجموعه</a>
            </td>
        </tr>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">        
      <a href='student_delete.php?id=<?php echo $student_group_id ; ?>& action=delete_group ' class='btn btn-danger col-12 p-3'> حذف المجموعه نهائي</a>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  ...
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <div class="form-group col-lg-10 mt-4" >
                <label for="fname" >رقم المجموعه :</label>
                <input class="form-control mt-2" type="text" disabled placeholder="<?php echo $student_group_id ?>">
              </div>

              <div class="form-group col-lg-10 mt-4" >
                <label for="name" >اسم  المجموعه :</label>
                <input class="form-control mt-2" id="name" name="name_update" type="text" required value="<?php echo $student_group_name ;?>" >
              </div>

              <div class="form-group col-lg-10 mt-4" >
                <label for="description" > وصف المجموعه :</label> <span class="text-secondary">Monday-Tuesday-11:00am</span>  
                <input class="form-control mt-2" id="description" name="description_update" type="text" required value="<?php echo $student_group_description ;?>" >
              </div>

              <div class="form-group col-lg-10 mt-4" >
                <label for="price" > مصاريف المجموعه :</label> <span class="text-secondary"></span>  
                <input class="form-control mt-2" id="price" name="price_update" type="number" required value="<?php echo $student_group_price ;?>">
              </div>
