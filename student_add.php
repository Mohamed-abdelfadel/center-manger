  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-sm-12 ">
        <h1 class=" font-weight-bold text-danger mt-5">معلومات اخر طالب</h1>
          ...
          <div class="form-group col-lg-9 mt-4" >
                <label for="group" >المجموعه :</label>  
                <input class="form-control mt-2" type="text" placeholder=" <?php if(isset($group)) {echo $group ;} ;?>" disabled  >
              </div>
          ...
          <div class="form-group col-lg-12 mt-4 d-flex justify-content-center" >
              ...
              <a href="student_edit.php?id=<?php if(isset($last_id)){echo $last_id ;} ?>" class="btn btn-danger  m-1 col-6">تعديل</a>
              </div>
        </div>
      </div>
</div>
