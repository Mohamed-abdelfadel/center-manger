    ...
    <div class="row">
        ...
        <form action="student_bills.php" method="GET" class="col-6" >
            <div class="form-group  ">
                ...
                <div class="col-lg-6" ><input type="number" id="bill_value" name="bill_value"  class="form-control  " placeholder="مبلغ الدفع" ></div>
            </div>
        </form>
        ...
        <tr>
            ...
            <form action="student_delete.php" method="get">
                <td  class="noprint row">
                    <button href="student_delete.php?id=<?php echo $student['id']; ?>" class="btn btn-success col-4">دفع المبلغ </button>
                    <div class="col-4">
