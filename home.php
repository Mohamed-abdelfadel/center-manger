...
<div  class="row d-flex justify-content-center">
  <div onclick="location.href = 'student_groups.php';" id="clickdiv" class="col-lg-3 col-sm-6 card p-5 btn btn-outline-secondary">
...
<div class="row d-flex justify-content-center">
  <div onclick="location.href = 'student_deleted.php';" class="col-lg-3 col-sm-6 card p-5 btn btn-outline-danger">
    <h1 class="mx-auto logo "><i class="fas fa-user-alt-slash"></i></h1>
    <label class="mx-auto mt-2 home_label"> المطرودين</label>
  </div>
  <div onclick="location.href = 'student_bills.php';" class="col-lg-3 col-sm-6 card p-5 btn btn-outline-success">
    <h1 class="mx-auto logo "><i class="fas fa-coins"></i></h1>
    <label class="mx-auto mt-2 home_label"> المصاريف</label>
  </div>
  <div onclick="location.href = 'student_exams.php';" class="col-lg-3 col-sm-6 card p-5 btn btn-outline-warning">
